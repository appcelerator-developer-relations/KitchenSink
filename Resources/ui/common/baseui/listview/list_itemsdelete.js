...
function getData(){
    var data = [
	    {properties: {title:'bad index=100. check parity',itemId:'101'}},
	    {properties: {title:'Delete Two',itemId:'2'}},
	    {properties: {title:'I will go too'}},
	    {properties: {title:'Item'}},
	    {properties: {title:'Item'}},
	    {properties: {title:'Delete Two',itemId:'2'}},
	    {properties: {title:'I will go too'}},
	    {properties: {title:'Item'}},
	    {properties: {title:'Delete Me',itemId:'1'}},
	    {properties: {title:'Item'}},
	    {properties: {title:'Item'}},
	    {properties: {title:'Delete Me',itemId:'1'}},
	    {properties: {title:'Item'}},
	    ...
	    {properties: {title:'Item'}},
	    {properties: {title:'Delete Me',itemId:'1'}},
	    {properties: {title:'excesive count=100. check parity',itemId:'100'}},
	    {properties: {title:'Item'}},
	    {properties: {title:'Item'}},
	    {properties: {title:'Item'}}
    ];
