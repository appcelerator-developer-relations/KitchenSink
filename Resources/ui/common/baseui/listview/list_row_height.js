function list_row_height(_args) {
    ...
    {template:'myCell', cellLabel:{text:'My height is coming from the template. My color when highlighted must be white'}},
    {template:'myCell', properties:{height:100},cellLabel:{
    	highlightedColor:'green',
    	color:'white',
    	text:'My height is coming from properties of the item. Must be 100. My color when highlighted must be green.',
