function list_event_sanity(_args) {
	...
	var data0 = [
	{properties:{title:'Alert 0,0,0',itemId:'0'}},
	{properties:{title:'Alert 0,1,0',itemId:'0'}},
	{properties:{title:'Alert 0,2,1',itemId:'1'}},
	]
	
	if(isIOS){
		data0.push({properties:{title:'Click Accessory/Row',itemId:'-1', accessoryType: Ti.UI.LIST_ACCESSORY_TYPE_DETAIL}})
	}
	section0.setItems(data0);
	
	var section1 = Ti.UI.createListSection({headerTitle:'SECTION 0'})
	var data1 = [
	{properties:{title:'Alert 1,0,0',itemId:'0'}},
	{properties:{title:'Alert 1,1,hello',itemId:'hello'}},
	{properties:{title:'Alert 1,2,1',itemId:'1'}},
	]
