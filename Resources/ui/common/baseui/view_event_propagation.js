function view_evt_prop() {
	...
	a.add(Ti.UI.createLabel({name:"label a",color:'white',text:'A',height:'auto',width:'auto',font:{fontSize:isBlackberry?30:48,fontWeight:'bold',fontFamily:'Helvetica Neue'}}));
	b.add(Ti.UI.createLabel({name:"label b",color:'white',text:'B',height:'auto',width:'auto',font:{fontSize:isBlackberry?30:48,fontWeight:'bold',fontFamily:'Helvetica Neue'}}));
	c.add(Ti.UI.createLabel({name:"label c",color:'white',text:'C',height:'auto',width:'auto',font:{fontSize:isBlackberry?30:48,fontWeight:'bold',fontFamily:'Helvetica Neue'}}));
	d.add(Ti.UI.createLabel({name:"label d",color:'white',text:'D',height:'auto',width:'auto',font:{fontSize:isBlackberry?30:48,fontWeight:'bold',fontFamily:'Helvetica Neue'}}));
	
	var l = Ti.UI.createLabel({
		color:'white',
		font:{fontSize:isBlackberry?9:14,fontWeight:'bold',fontFamily:'Helvetica Neue'},
		bottom:5,
		textAlign:'center',
		text:'click anywhere',
		height:'auto',
	...
	var l2 = Ti.UI.createLabel({
		color:'white',
		font:{fontSize:isBlackberry?9:14,fontFamily:'Helvetica Neue'},
		bottom:25,
		textAlign:'center',
		text:'',
		height:'auto',
